...
<main id="pagina2">
    ...
    <section class="contenedor" id="blog">
            <div class="site-content">
                ...
                <aside class="sidebar">
                    <!-- <div class="login newsletter" data-aos="fade-up" data-aos-delay="300">
                        <form class="form-element" id="login" name="login">
                            <input type="hidden" name="submit" value="1">
                            <input type="text" class="input-element" name="name" id="usuario" placeholder="Ingresa tu usuario">
                            <div id="error_4"></div>
                            <input type="password" class="input-element" name="password" id="password" placeholder="Ingresa tu contraseña">
                            <div id="error_5"></div>
                            <input id="ingresar" class="post-btn" type="button" value="Ingresar">
                        </form>
                    </div> -->
                    <div class="category">
                        <h2>Categorías</h2>
