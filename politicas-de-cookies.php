    ...
    <main>
        <section class="contenedor-legales" id="cookies">
            <div class="info-container box-nosotros">
               ...
               <p>Como responsable de esta web, me he esmerado en cumplir con la normativa referente a las cookies, no obstante, teniendo en cuenta la forma en la que funciona Internet y los sitios web, no siempre es posible contar con información actualizada de las cookies que terceras partes puedan utilizar a través de este sitio web.</p>
               ...
               <br>
               <h5>I. Las cookies que utiliza esta web</h5>
               ...
               <p>Las cookies empleadas en https://regiaproducciones.com/ no pueden leer datos de su disco duro ni incluir virus en sus textos. Asimismo, https://regiaproducciones.com/ no puede leer las cookies implantadas en el disco duro del Usuario desde otros servidores.</p>
               <p>El usuario puede libremente decidir acerca de la implantación o no en su disco duro de las cookies empleadas en https://regiaproducciones.com/. En este sentido, el usuario puede configurar su navegador para aceptar o rechazar por defecto todas las cookies o para recibir un aviso en pantalla de la recepción de cada cookie y decidir en ese momento su implantación o no en su disco duro. Para ello le sugerimos consultar la sección de ayuda de su navegador para saber cómo cambiar la configuración que actualmente emplea.</p>
               <p>Aun cuando el Usuario configurase su navegador para rechazar todas las cookies o rechazase expresamente las cookies de https://regiaproducciones.com/ podrá navegar por el Portal con el único inconveniente de no poder disfrutar de las funcionalidades del Portal que requieran la instalación de alguna de ellas. En cualquier caso, el Usuario podrá eliminar las cookies implantadas en su disco duro en cualquier momento, siguiendo el procedimiento establecido en la sección de ayuda de su navegador.</p>
               ...
               <br>
               <h5>II. Las cookies de esta web ayudan a:</h5>
               <p>
                   <ul>
               ...
               <br>
               <h5>No utilizaré jamás cookies para:</h5>
               <p>
                   <ul>
               ...
               <br>
               <h5>Cookies de terceros que utilizamos en esta web y que debes conocer</h5>
               <p>Esta web, como la mayoría de sitios web, incluye funcionalidades proporcionadas por terceros.
                También se ponen a prueba regularmente nuevos diseños o servicios de terceros para recomendaciones e informes.</p>
               ...
               <p>Entre las cookies de terceros más estables están:
                   <ul>
                       <li><span>Las generadas por servicios de análisis</span>, concretamente, Google Analytics para ayudar al website a analizar el uso que hacen los Usuarios del sitio web y mejorar la usabilidad del mismo, pero en ningún caso se asocian a datos que pudieran llegar a identificar al usuario.
               ...
               <br>
               <h5>¿Cómo puedo gestionar y desactivar estas cookies?</h5>
               <p>En el caso de desear que el sitio web no instale ninguna cookie en tu equipo, cabe la posibilidad de adaptar tu navegador de modo que se te notifique antes de que se descargue ninguna cookie.</p>
